...
var BaseConnection = class extends EventEmitter__default.default {
  constructor() {
    ...
    this.client = new jsonRpc2_0.JSONRPCClient(this.sendRequest.bind(this));
...
var FuelWalletProvider = class extends fuels.Provider {
...
exports.PAGE_SCRIPT_NAME = PAGE_SCRIPT_NAME;
